 ...
 * 保存済み経歴書（ResumeResponse）のみ。マッパーは created_at / updated_at を参照しない
 * ため、timestamps を除いた形で受ける。
 *
 ...
 */
export type ResumeFormSource = Omit<ResumeResponse, "created_at" | "updated_at">;
